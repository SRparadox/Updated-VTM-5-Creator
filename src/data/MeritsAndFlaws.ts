...
export const loresheets: Loresheet[] = [
    ...
    },
    {
        ...
        summary: "Former Sabbat Lasombra who rejected the idea of fighting for any cause, preaching radical egoism and pursuing strength, ambition, and self-governance above all.",
        source: "Custom",
        requirementFunctions: [],
        merits: [
            ...
            { name: "Will of Liberty & Ability", cost: [2], summary: "You gain six free specialties in separate skills. However your powers of Dominate and Presence that affect others cost a point of Willpower in addition to any other costs." },
            ...
            { name: "No Control But Mine", cost: [4], summary: "Whenever someone uses the powers of Dominate or Presence on you, your very blood automatically writhes to resist and despise them. They become an additional Vendetta. You can have up to three additional Vendettas gained this way and all of your Vendetta-based Merits affect each of them. You also gain three dots to spend across Vendetta Merits." },
    ...
    },
    {
        ...
        summary: "You became Ductus, leader of faithful remnants of the Sabbat. You forged your Pack in battle.",
        source: "Custom",
        requirementFunctions: [],
        merits: [
            { name: "Pack Duties", cost: [1], summary: "At the start of each Story you may assign a specific duty to each of your Packmates. Upon fulfilling their assignment, a Packmate recovers one Superficial or Aggravated point of Willpower." },
            { name: "Zealous Frenzy", cost: [2], summary: "When you, or a Packmate would enter Frenzy of any kind, you may choose to take a point of Aggravated Willpower Damage to stoke their Beast towards zealous wrath, causing them to enter a Zealous Frenzy. While in this Frenzy a Cainite will attempt to carry out the beliefs of themselves and their Pack at all costs, ignoring even their own self-preservation, they will also attack their Packmates last. The total Stains gained while in a Zealous Frenzy are reduced by 1 when it ends." },
            ...
            { name: "Reforged Blade", cost: [5], summary: "Once per Story you may pick any Cainite, regardless of Sect. The chosen Cainite becomes an additional Vendetta for you and everyone in your Pack. Whilst working against this Vendetta, the numerical effects of every other Background on this Sheet are doubled, and any Teamworked pools add two additional dice." },
        ],
    },
    {
        title: "NULL",
        summary: "Legendary hackers Embraced by Lasombra as punishment for exploiting the wrong weakness and seeing data that revealed the world of darkness.",
        source: "Custom",
        requirementFunctions: [isClan("Lasombra")],
        merits: [
            { name: "BANEWARE", cost: [1], summary: "When touching a piece of modern technology you have a Specialty associated with, you can make a Rouse Check and make a Bane Severity + Technology; Difficulty 3 Test. A Win disables the tech for a number of minutes equal to the Successes on the roll, while a Critical fries it. Once per Story you may count your Bane Severity as one lower in regards to modern technology." },
            { name: "Digital Entropy", cost: [2], summary: "Once per Story you can choose to be treated as Zeroed in regards to online data for a single night. Your face will be gone from online photos, records about you will feature corrupt data, and posts on social media simply won't load." },
            { name: "Undead OPS", cost: [3], summary: "You've been invited to join a Cainite hacker group. You gain one group as a Mawla (●●●) along with their benefits. But the others become Adversaries (●)" },
            { name: "Cyber-Syndicate", cost: [4], summary: "You gain two Retainers(●●) that assist in digital endeavors, becoming your hands. You can always Teamwork with their tech-related pools, even if their Skill rating is lower than yours, and when you do, you add two dice instead of one." },
            { name: "Legacy Exploit", cost: [5], summary: "Once per Story you can automatically breach any piece of digital security, even ignoring your Bane. This results in you gaining classified or sensitive data that can be blackmailed or sold for Major Boons and Backgrounds, or set up another Kindred for failure. Backgrounds gained this way are permanent and usually (●●) or more." },
        ],
    },
    {
        title: "Sword-Seraph Malchus",
        summary: "Bound to Malchus, a War Priest who lead a doomed Crusade and shattered an Antediluvian cult, fusing Abyssal rites and the sacrament of Diablerie.",
        source: "Custom",
        requirementFunctions: [],
        merits: [
            { name: "I Am Wielded", cost: [1], summary: "You bear ritual tattoos of Malchus' Abyssal power. You are always aware when someone uses Dominate or Presence on you. While committing Diablerie, add one die to Blood Surge rolls. If the Rouse Check for the Surge results in a 1 or 10, gain a Stain and add two dice instead." },
            { name: "Empty Conviction", cost: [2], summary: "If you commit harm against an innocent Human, reduce the Stains incurred by one for each Touchstone you lack beneath the standard limit of three. If you have no Touchstones at all, Once per Story, at the end of a Session, you may convert your Stains into an equal amount of Aggravated Damage." },
            ...
            { name: "Taken Prince", cost: [4], summary: "Once per Story you can choose one Cainites you've Diablerize, raising your Hunger by 1 and vomiting out ink-black ichor that forms into a Taken. This Taken obeys only your commands. At the Scene's end, it violently rebinds to your soul, inflicting 1 Aggravated Willpower damage." },
            { name: "Via Laminarum", cost: [5], summary: "You do not suffer an automatic loss of Humanity for committing Diablerie, however a portion of the power you take is tithed to this path's creator, the Blade-Seraph, reducing the total Experience gained from Diablerie by 10, down to a minimum of 5." },
        ],
    },
    {
        title: "The Hadal Companies",
        summary: "A Kindred private military force led by ex-Ducti, selling hardened soldiers and ruthless solutions to those willing to pay.",
        source: "Custom",
        requirementFunctions: [],
        merits: [
            { name: "Cynical Merc", cost: [1], summary: "Add a bonus die to any pools made towards negotiating a price for your services and to any pools made to resist the idealist rhetoric of a cause." },
            ...
            { name: "Soldier's Fortune", cost: [3], summary: "You have your own Company. You gain three one-dot Mawlas. Add an additional die to Leadership rolls in regards to your Company. You can call on them to assist you, however they will always require compensation in the form of Boons, Backgrounds, or some kind of loot." },
            { name: "Deep Debts", cost: [4], summary: "Work with your Storyteller to choose a powerful or influential Storyteller Character. At least Once per Story they require your services. If you succeed in solving their problem, they pay you in Boons, or in two dots of Backgrounds. Should you succeed in solving their problems twice in a row, they become your Mawla (●●●)." },
            { name: "Mercenary's Gambit", cost: [5], summary: "Once per Story, you may call any number of other Hadal Company members to assist you. When doing this, the other Company counts as a Mawla (●●●●●) until the end of the Session. You can maintain them each Session thereafter, but doing so requires them to be paid in a cumulative upkeep of five dots of Backgrounds, increasing by two additional dots each Session." },
        ],
    },
    {
        title: "Liminal Space",
        summary: "You've stumbled upon Liminal Spaces that are both haven and hazard. Avenue and destination. Something enticing and foreboding that longs to understand and utilize you.",
        source: "Custom",
        requirementFunctions: [],
        merits: [
            { name: "Heterotopia", cost: [1], summary: "You gain a Heterotopia, a type of Liminal Space, as a Haven (●). Others who enter this Haven must make a Test of Resolve + Awareness (Interiors) or Survival (Exteriors); Difficulty equal to the Haven's Rating, else they become lost for an hour. Each other Background you purchase on this sheet increases the rating of this Haven provided by this Background by one." },
            { name: "Skeined Meandering", cost: [2], summary: "Add three dice to any navigational pools to escape a place or location (supernatural or not) and add that same bonus when attempting to lead others into a place they'll get lost in. Malkavians and Lasombra add five dice instead." },
            { name: "DOP", cost: [3], summary: "Once per Story you can will yourself into a place full of lost things. When you do, roll your Willpower; Difficulty 2. For each Success beyond the margin, you gain an equal number of dots to spend across Resources or Herd. These backgrounds are once again lost at the end of the Story." },
            { name: "Transcursion", cost: [4], summary: "Once per Story, you can make a Rouse Check and a Resolve + Awareness or Survival; Difficulty 3 Test as you pass through a doorway or another threshold, and out of sight. A Win causes you to simply vanish and reappear in another location within fifty yards/meters adjacent to the one you were in." },
            { name: "Failure of Presence", cost: [5], summary: "Once every other Story you can take a point of Aggravated Willpower Damage to enforce a Failure of Presence at a location for a single Scene. During this time the location will be populated only by you and those you bring with you or allow, as well as aspects and conjurations of Oblivion. This place also counts as a Heterotopia with a five dot rating for purposes of escape and navigation." },
        ],
    },
    {
        title: "Vanta Capital",
        summary: "You oversee a regional branch of Vanta Capital, a financial apparatus used to choke competitors and manipulate entire domains through debt and dependency under the auspices of the Clan of Shadows.",
        source: "Custom",
        requirementFunctions: [isClan("Lasombra")],
        merits: [
            { name: "Night Shift", cost: [1], summary: "Gain a Retainer (●), Contacts (●), and Herd (●) which symbolize those that work under you. If you falter or show weakness, a subordinate will seize their chance becoming a secret (●) Enemy until cowed or replaced. Once per Story you can make Quick Hunts within your own office, however a failed hunt attracts the Board." },
            { name: "Performance Review", cost: [2], summary: "Create three departments that you oversee. Each Story one of these three departments outmaneuvers the other two, granting you Influence (●●●) associated with that department. This influence is lost at the end of the story." },
            { name: "Shadow Ledger", cost: [3], summary: "Gain four dots to distribute between Contacts and Resources, neither of which can ever be tracked or found by other Kindred unless you reveal them. Additionally, Projects made to increase the ratings in these two backgrounds have their base difficulties decreased by one." },
            { name: "Purchased Services", cost: [4], summary: "Every other Story someone hires Vanta to deal with another Kindred in your area. You can either execute the plan (gaining a permanent dot in Retainer, Contacts, Influence, or Herd) or undermine the operation (warning the target for two Major Boons and adding two dice to any pools made against Vanta)." },
            { name: "Play for the Crown", cost: [5], summary: "Once per Story, you may leverage devastating blackmail to demand four dots in a Background of your choice. You can also use Vanta Capital itself as a Stake in launched Projects, where it counts as five dots. However you gain Alarico Cardenal and the Board as Adversaries (●●●)." },
        ],
    },
    {
        title: "Pupil of Professor Vidar",
        summary: "You were the favored pupil of Professor Walter Vidar, whose mortal life as an immigrant scholar was replaced with the cold ambition of the Clan of Shadows. Now you inherit the bones of his empire.",
        source: "Custom",
        requirementFunctions: [],
        merits: [
            { name: "Magister's Strings", cost: [1], summary: "When someone tries to investigate your Allies, Contacts, Retainers, or Mawali, their difficulties to do so are increased by 1. If they fail their roll you're tipped off by the end of the night, though you may not know who it was." },
            { name: "The Blue Dahlia", cost: [2], summary: "Gain a yacht as a Haven (●) with the Mobile (●) and Armory (●) addons. Tests to spot it at night have their difficulties increased by its Haven rating." },
            { name: "Shadows of the Past", cost: [3], summary: "You may purchase criminal Contacts at a rate of two Experience per dot, rather than three. However those Contacts know your affiliation with Vidar, and might use it as leverage should they run into trouble with the law." },
            { name: "Horrors of a Lawful Rat", cost: [4], summary: "Gain a Sabbat Ductus and a Camarilla mainstay each as a Mawla (●●). Once per Story the Reeve or one of these Mawlas will have a task that doesn't benefit you. If you pull this task off three Stories in succession, you gain the Reeve as a Mawla (●●)." },
            { name: "The Eternal Empire of Want", cost: [5], summary: "When you want to find out what another Kindred wants or how to get it, you may make an Intellect + Contacts; Difficulty 5 Test. If your Character suffers Final Death, you can choose your next Character to inherit up to ten dots of your Backgrounds for free at creation." },
        ],
    },
    {
        title: "Qabilat al-Khayal",
        summary: "\"The Faithful\" Lasombra of the Ashirra who harbor genuine believers in God's existence and maintain connections between the Ashirra and the Camarilla.",
        source: "Custom",
        requirementFunctions: [isClan("Lasombra")],
        merits: [
            { name: "Dual Allegiance", cost: [1], summary: "Your Fame and Status in the Ashirra also applies to the Camarilla, as well as the reverse." },
            { name: "Mercantile Nights", cost: [2], summary: "Once per Story you can locate an Ashirran Merchant who will give you a free item worth Resources (●). You and those who arrive with you can purchase additional items from this seller." },
            { name: "Aptitudes for Greatness", cost: [3], summary: "You gain the free specialty 'Enemies of the Ashirra' in Stealth, Subterfuge, and Politics. You can also purchase this same Specialty in any other skill. The first time each Story a pool that includes a bonus from that specialty critically succeeds, increase the associated Skill by one, up to a maximum of four." },
            { name: "A Scorching Fast", cost: [4], summary: "When you roll to resist Hunger Frenzy, it is always done at Difficulty 2." },
            { name: "The Shadow's Head", cost: [5], summary: "You gain Status (●●●●) with the Ashirra, and a Lasombra Mawla (●●●) who has direct connections with Les Amis Noirs. In most matters of local governance and politics, your judgement and direction is taken into account and will be backed by the Ashirra and its members." },
        ],
    },
    {
        title: "Edge of the Sword",
        summary: "You were left as a vanguard when the faithful marched to wage their Gehenna Crusade. Now you wage a personal crusade, pursuing your monstrous ideals without the patronage of a tottering Pack.",
        source: "Custom",
        requirementFunctions: [],
        merits: [
            { name: "Mark of Caine", cost: [1], summary: "Using a blade, you can etch your personal symbol into a place, object, or person. Those that see this symbol become wary of you, feeling it in their very Beast. They add one die to their Awareness pools, but you add two dice to your Intimidation pools made against them until they leave the mark behind." },
            { name: "Every Arsenal, a Home", cost: [2], summary: "You gain a Haven (●) and each one of your Havens also has a number of dots in Hidden Armory equal to its rating for free." },
            { name: "Shovel Party", cost: [3], summary: "Once per story, you may take two Stains and perform a Mass Embrace, creating a pack shovelheads (Mawla ●●●) under your command. Add two dice to any pools made to command them. They are destroyed or scattered by the end of the Story if you don't purchase them with Experience (costs 2 Experience per dot)." },
            { name: "In his Image", cost: [4], summary: "When you brutalize a Mortal to within an inch of their life, you may leave them for others to find. One or more Kindred connected to that Character will be frozen to inaction for the remainder of the story and refuse to make any moves at all." },
            { name: "The Fire Rises", cost: [5], summary: "Tracking your movements or identifying your direct involvement is always done as a -2 Called Shot. You gain Fame (●●●) with disillusioned outcasts. Once every other Story you can incite a violent uprising using this group, which will distract any Sect or Mortal institution until the end of the night." },
        ],
    },
    {
        title: "Abyssal Mystic",
        summary: "Following in the wake of the first Lasombra who plunged into the deepest darkness to wrest the secrets of the Abyss, those who follow this practice are feared even by their own clan.",
        source: "Custom",
        requirementFunctions: [],
        merits: [
            { name: "Distant Heart", cost: [1], summary: "When you take this Background, you may reduce your Stamina by 1 if it is 2 or higher. If you do, increase your Composure by 1. A 1 or 10 on a Rouse Check that would grant you a Stain recovers 3 Superficial Willpower or 1 Aggravated Willpower. However you no longer recover Willpower in regards to your Ambition, Desire, or Touchstones." },
            { name: "Drown the Beast", cost: [2], summary: "Once per Story, when you Frenzy you may roll your Resolve + Oblivion in place of the typical pool to resist Frenzy. On a Win, you cast your Beast into your shadow causing it to Frenzy in your place. While in this Frenzy it gains your powers of Oblivion and can even detach to sew chaos elsewhere." },
            { name: "Ex Nihilo", cost: [3], summary: "You can take Oblivion powers without their Amalgam requirements. If they require a rating in a Discipline you don't have in order to function, use your Occult rating instead." },
            { name: "Oubliette", cost: [4], summary: "You have a place where light never shines and cannot shine. This Oubliette counts as a Haven(●●●) and while you dwell there you cannot be found or affected by supernatural forces outside of it, such as Wraiths, Sorcery, or Auspex. This place can still be found, however." },
            { name: "Via Negativa", cost: [5], summary: "Your Oblivion pools suffer no Dice penalties of any kind from anything. Ever. Add a bonus die to your Oblivion and Occult pools for each of the following: Your Health is fully marked, Your Willpower is fully marked, Your Hunger is at 0, Your Humanity is 4 or lower." },
        ],
    },
    {
        title: "Les Amis Noirs",
        summary: "The Friends of the Night have steered the Clan in ways that ensure its survival and prosperity. You are being watched, weighed, and quietly judged for an invitation into this society.",
        source: "Custom",
        requirementFunctions: [isClan("Lasombra")],
        merits: [
            { name: "Relentless Drive", cost: [1], summary: "Once per Story when you choose to spend Willpower to re-roll up to three dice, you may take a point of Aggravated Willpower Damage instead. If you do, add two additional dice to those that are re-rolled." },
            { name: "A Friend in the Night", cost: [2], summary: "You gain an unknown benefactor as a Mawla (●●●). Once per Story they will grant you access to Allies (●●●), Contacts (●●), or Resources (●●) at a moment's notice. However, whenever you suffer a clear failure to achieve a goal, the Mawla, and any background they provided, vanish until the end of the next Story." },
            { name: "Blood Judge", cost: [3], summary: "Once every-other Story you are invited to sit in, or perhaps even judge, a fellow Lasombra in the Courts of Blood. You may openly argue for their salvation or destruction, making a Series Test requiring three separate Social Tests at Difficulty 4. Being invited to a Blood Court grants you Status (●●) and Fame (●) with the local Court." },
            { name: "Night's Mandate", cost: [4], summary: "You've been handed genuine authority by the Friends. Choose a grand, but attainable, goal. All Lasombra in the city must work towards that goal. Those that fail to advance it are brought to the Courts of Blood for summary judgement." },
            { name: "Friend of the Night", cost: [5], summary: "You are a full member of the Friends. Add three dice to your Leadership, Politics, and Intimidation pools. Other prominent Kindred outside your Clan value (or fear) your actions and judgement. When you interact directly with Lasombra, regardless of Sect, your Status is treated as one dot higher than there's, so long as they themselves are not also a Friend of the Night." },
        ],
    },
    {
        title: "The Weirdling Kiasyd",
        summary: "Kiasyd have a long history of being associated with fae-creatures, infernal gods, or some cryptid of the dark. These Weirdlings live up to their name with glowing skin and pitch-black eyes.",
        source: "Custom",
        requirementFunctions: [isClan("Lasombra")],
        merits: [
            { name: "Fictional Accounts", cost: [1], summary: "Whenever you're in conversation with someone who knows they're consciously lying, you suffer a point of Superficial Willpower Damage. This can manifest as a ringing in the ears, an ice-pick headache, or your hands cramping. You can choose to disable this effect at any time." },
            { name: "Off-Seeming", cost: [2], summary: "Choose one or more strange qualities: BAOBHAN SITH (raven black hair with feathery pinions, extendable black talons), BLACK-EYED CHILDE (pitch-black eyes, Folkloric Block Flaw, bonus dice to Intimidation in homes), or ZEERNEBITE (learn Blood Sorcery at out of Clan costs, repelled by holy iconography)." },
            { name: "Arcane Alignment", cost: [3], summary: "Once per Story you're given a task to find an occult-related object or rite. This has made you well-connected in the local occult and collector scenes. Spend four dots across Contacts and Mawlas that are related to those subcultures." },
            { name: "Riddle Phantastique", cost: [4], summary: "Once per Story you can make a Rouse Check to tell a captivating riddle and roll your Intelligence + Manipulation; Difficulty equal to any listener's Willpower. A Win forces those who heard the riddle to contemplate it for the rest of the Scene. Non-mortals can end the effect early by spending Willpower." },
            { name: "A Fool's Trick", cost: [5], summary: "Once per Session, for a single scene, you can become a Thin-blood, reducing your Blood Potency to zero, losing all but one dot in a single Discipline, and gaining the Lifelike Thin-blood Merit. You may even be able to learn Thin-blood Alchemy as an in-Clan Discipline." },
        ],
    },
    {
        title: "Ombre di Cristo",
        summary: "Some Lasombra claim their Clan Embraced Christ himself. This Bloodline are Embraced from those who have lost everything but keep their faith strong, using their beliefs as a cornerstone for their actions.",
        source: "Custom",
        requirementFunctions: [isClan("Lasombra")],
        merits: [
            { name: "Sanguis Convictionis", cost: [1], summary: "When a Mortal drinks a Rouse Check of your Vitae directly from the vein, choose one of your Convictions. It heals them of a chronic condition or permanent impairment for up to one month. However if they don't act in accordance with the chosen Conviction, their afflictions return by the end of the Scene with increased severity." },
    ...
    {
        title: "Angellis Ater",
        summary: "A Bloodline of Satanist Lasombra who have twisted the beliefs of their Catholic Clanmates into acts of rebellious infernalism. These \"Black Angels\" believe Obtenebration's power comes from Satan himself.",
        source: "Custom",
        requirementFunctions: [isClan("Lasombra")],
        merits: [
            { name: "Guiltfeeder", cost: [1], summary: "Whenever another Character receives one or more Stains in your presence, you restore an equal amount of Health or Willpower, Superficial or Aggravated." },
            { name: "Demonic Tutor", cost: [2], summary: "You know of a Baali who is willing to teach you a deeply Infernal form of sorcery, allowing you to learn Blood Sorcery Powers and Rituals as Powers and Ceremonies of Oblivion instead. However the Baali will require you to do some hellish work that usually results in a Stain as payment." },
            ...
            { name: "Profane Prayers", cost: [4], summary: "Once per Story you may pray to Satan and beg him to grant you power. The response fills your unmarked Humanity Tracker with Stains. However his demonic providence allows you to use another background you have access to with a \"Once per Story\" maximum use effect an additional time this Session." },
            { name: "Damnation", cost: [5], summary: "Once per Story you can completely ignore the effects of True Faith for a Scene. While under this effect, blessed liquids boil, candles snuff, holy objects flash-heat to cherry red, and places of worship collapse to ruins as you manifest the wrath of Hell." },
        ],
    },
    {
        title: "Drowned Knights",
        summary: "The Order of Saint Adjutor patrolled shores and waters, exploiting the in-fighting of the Ashirra. These Knights have slowly skewed their beliefs throughout the ages, infusing their Christian rites with sea-based religion.",
        source: "Custom",
        requirementFunctions: [isClan("Lasombra")],
        merits: [
            { name: "A Knight's Menace", cost: [1], summary: "While outside of physical combat your difficulties to resist Fury Frenzy are reduced by 2, but in combat they're increased by 2. Your shadow manifested by Oblivion always appears \"wet\" or \"drenched\". Whilst in Fury Frenzy your shadow flickers and flashes, like clouds in a thunderstorm." },
            { name: "Tempestarii", cost: [2], summary: "A descendant of the Tempestarii has sworn an oath to you. They count as a Retainer (●●) that has a supernatural sense for storms and will perform a Ceremony that affects you as if you performed it." },
            { name: "Old Remembrances", cost: [3], summary: "Choose a level 1 Animalism, Potence, or Oblivion power. While wielding a heavy melee weapon you gain that power as if you know it. Your level is treated as 1 for that power. Heavy melee weapons are Strength-based implements with a Damage Value of +4 or higher." },
            { name: "Thou Shalt Not Relent", cost: [4], summary: "While in an enemy Domain, your Composure and Resolve pools are increased by 1." },
            { name: "The Salted", cost: [5], summary: "Any Domain you're currently in, or defending, counts as two dots higher in its Portillon rating. Additionally you gain five dots in Warding to spend across any Havens, even ones that aren't yours. You can redistribute these dots once per Story." },
        ],
    },
    {
        title: "Progeny of Gratiano",
        summary: "You descend from Gratiano, who played the role of dutiful son before committing patricide against Lasombra himself. His blood carries talents for political upheaval and power.",
        source: "Custom",
        requirementFunctions: [isClan("Lasombra")],
        merits: [
            { name: "Tongue of the Courtier", cost: [1], summary: "Add a die to your Manipulations and Charisma pools made in regards to those whose authority or Status exceeds your own when showing obedience and concealing any true motives. When you betray a character you were previously obedient to, they become your Vendetta." },
            { name: "The Rebel's Call", cost: [2], summary: "You gain four dots to spend across Status and Mawlas in regards to Sabbat and Anarch Cainites, however you have an Adversary (●) in the form of a Lasombra seeking to take your head to buy their way into the Ivory Tower." },
            { name: "Fresh Opportunity", cost: [3], summary: "When a political position opens, or the chance at leadership presents itself, you may add four dice to the first pool you make to convince others that you're fit for the role." },
            { name: "A Certain Mastery", cost: [4], summary: "You are completely immune to the effects of Dominate and Presence powers you know." },
            { name: "Unfinished Legacy", cost: [5], summary: "You and those that taste your blood add two bonus dice to their Strength and Resolve Tests made towards Diablerie until they feed or reach Hunger 5. However those that successfully Diablerize you suffer an additional automatic Humanity loss." },
        ],
    },
    {
        title: "Ascetics of the Dark",
        summary: "An Abyssal Bloodline descended from unknown methuselahs who were Ascetics believing they could become tutelary deities via abstinence from light and warmth.",
        source: "Custom",
        requirementFunctions: [isClan("Lasombra")],
        merits: [
            { name: "Tutelary Rites", cost: [1], summary: "You can teach Ceremonies you know to others, and when you do they learn them twice as fast and their costs to purchase with Experience are reduced to two per dot. Additionally you learn the Oblivion Ceremony Poet's Prose, even if you don't have the required Oblivion or the prerequisite power." },
            { name: "Beyond the Horizon", cost: [2], summary: "Your concentration cannot be interrupted as long as you wish to maintain it outside of provocations of Frenzy or if the interrupting effect is from a Critical." },
            { name: "Pilgrims of the Dark", cost: [3], summary: "Once per Story, you may take a point of Aggravated Willpower Damage to pin a non-Hunger die to a 10 on all Willpower, Stamina, and Resolve Tests for the remainder of the Scene." },
            { name: "Nightless Night", cost: [4], summary: "When you roll a pool that includes Auspex or Oblivion, you may pin one of your Hunger Dice to an automatic 10 and set it aside before rolling the rest of your pool. A Messy Critical on the roll causes the Abyss to spring forth into reality, manifesting as a dark doppelganger that actively works against you." },
            { name: "Poets and Elder Gods", cost: [5], summary: "You've come into contact with a descendant of the Scrivener, who you gain as a Mawla (●●●) that has three pages of the Scrivener's Manuscript. You can study a Manuscript Page to divine information that allows you to automatically pass any Resolve or Intelligence Test related to Oblivion." },
        ],
    },
    // {
    //     title: "Sample",
