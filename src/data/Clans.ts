...
export const clans: Record<ClanName, Clan> = {
    ...
    banes: [
        ...
        compulsions: ["Perfectionism: Until you score a critical win, all actions have a two-dice penalty. Penalty is reduced by one die for every repeat of an action."],
    ...
    banes: [
        ...
        compulsions: ["Arrogance: Until somebody obeys an order from you (not forced by Dominate), you take a two-dice penalty on all rolls not related to leadership."],
    ...
    banes: [
        ...
        compulsions: [
            ...
            "Hollow Heart: A sinking feeling, cold comfort, numbness. Your Beast drowns in the nihilism of the void. There is an inevitable nothing that will forever be empty, a hole that can't be filled with an ocean of emotion, wealth, praise, or success. Your attention and determination is eroded by waves cold detachment. Your Stamina, Resolve, and Composure pools suffer a -2 penalty until the end of the Scene, or someone rouses you from this stupor by getting a Critical Success against you.",
            "Righteous Indignation: The only anchor in your life is stead-fast adherence to values that keep you steady amidst the uncertainty of the night. This compulsion manifests when you fail to operate on this personal code and your Beast is quick to steer that moral compass against you. You get a -3 dice penalty on all pools that don't directly act out one or more of your Convictions, as well as your pools to resist Frenzy. This lasts until you successfully win a Test of any kind with an aggressive action, or until you Frenzy."
        ],
        nativeDisciplines: ["dominate", "potence", "oblivion", "obtenebration"],
    },
    "Banu Haqim": {
        name: "Banu Haqim",
    ...
    banes: [
        ...
        "Sorcerer Spirit: The connection with spirits that follow the sorcerers and their craft makes them and their spells reek with magic that is quite hard to miss. Any supernatural method (like Sense the Unseen or Scry the Soul when looking for effects on a person) to detect the sorcerer or their magics count their as a successes as higher by half the sorcerer's Bane Severity, rounded up. This includes things such as curses, Obfuscate and wards. Any aura-reading powers (such as Scry the Soul) that are used on the sorcerer automatically reveal the sorcerer to be both a vampire and a blood magician on a win, even if they have no dots in Blood Magic Disciplines.",
        "Absolute Perfectionists: Perfectionist in whatever they do, the vizier bane manifests itself as an obvious interest and an obsession with something. At character creation or at Embrace, the vizier picks out a single specialty they possess in any Mental Skill or Crafts or Performance to be their obsession. The Skill chosen must be something that the character regularly spends their time on and should not be something obscure that will never have the opportunity to come up in the game. Whenever they get an opportunity to indulge that obsession, talk about it or learn more on it, the player must make a Willpower roll at a difficulty of 1 + their Bane Severity. On a failure, their attention becomes occupied and they suffer a two-dice penalty to all rolls until they indulge the obsession and learn what they can from it. Any aura-reading power such as Scry the Soul on a win reveals the vizier's obsession as even their aura will be seen indulging or attempting to chase indulging it. The vizier's interest may also be perceived by those observing them while pursuing their interest, making a Wits/Resolve + Insight roll against a difficulty of 7 minus the vizier's Bane Severity. A win reveals the vizier's interest."
    ],
        compulsions: [
            ...
            "Kalif Addiction: Sorcerers of the Children of Haqim use kalif to climb the stairs of Heaven, receiving visions and opening the inner eye so that they may directly contact the spirits. Constant usage of that has embedded itself in the vitae of all sorcerers, forcing them to find it or cultivate it with the end goal being personal consumption. The vampire suffers a two-dice penalty to all rolls until they consume at least one dose of kalif.",
            "Schemes: Viziers are careful schemers who play the long game to achieve their goals, but sometimes those goals can not come soon enough. Gain a two-dice penalty on all rolls that do not immediately advance one's Desire or Ambition. The compulsion lasts for one night or until the Desire has been completed or Ambition advanced."
        ],
        nativeDisciplines: ["celerity", "obfuscate", "blood sorcery", "quietus"],
    },
    Ministry: {
        name: "Ministry",
    ...
    banes: [
        ...
        compulsions: ["Transgression: Take a two-dice penalty on all rolls not related to enticing someone (even themselves) to break a Chronicle Tenet or personal Conviction, causing at least one Stain and ending this Compulsion."],
        nativeDisciplines: ["obfuscate", "presence", "protean", "serpentis"],
    },
    Ravnos: {
        name: "Ravnos",
    ...
    banes: [
        ...
        compulsions: ["Tempting Fate: Next time you're faced with a problem, you must choose the most dangerous and daring solution, or take a two-dice penalty. Lasts until the problem is solved or further attempts are impossible."],
        nativeDisciplines: ["animalism", "obfuscate", "presence", "chimestry"],
    },
    Tzimisce: {
        name: "Tzimisce",
    ...
    banes: [
        ...
        nativeDisciplines: ["animalism", "dominate", "protean", "metamorphose", "koldunic"],
    },
    Hecata: {
        name: "Hecata",
    ...
    banes: [
        ...
        compulsions: ["Morbidity: Until you have either predicted a death or solved the cause of a local one, you suffer a three-dice penalty to other rolls. Conclusions don't need to be correct, but should make sense."],
        nativeDisciplines: ["auspex", "fortitude", "oblivion", "necromancy"],
    },
    Salubri: {
        name: "Salubri",
    ...
    banes: [
        ...
        compulsions: ["Affective Empathy: Become overwhelmed with somebody's personal problem. Suffer a two-dice penalty to all actions that don't got towards solving the problem. Lasts until the problem is eased, an immediate crisis supersedes it or the scene ends."],
        nativeDisciplines: ["auspex", "dominate", "fortitude", "valeren"],
    },
        Lamia: {
            name: "Lamia",
        ...
        Nagaraja: {
            ...
            compulsions: ["Dead Temple: The vampire is compelled be among the dead, they feel an overwhelming urge to surround themselves with the dead, even a pile of bones will comfort them. If they cannot find a corpse they will be compelled to make one."],
            nativeDisciplines: ["auspex", "dominate", "oblivion", "necromancy"],
        },
        ...
        Lhiannan: {
            ...
            compulsions: ["ZOOCHOSIS: Modern life is closing in around you. Streets packed with loud vehicles, narrow alleyways reeking of rot and garbage, the cries and constructions of unnatural society layered onto itself. When this compulsion manifests you tend to revert to a more primitive mental state; Repeating monotonous tasks, scratching the surface of your desk into a groove, or grinding your teeth. These effects confer a -2 Dice penalty to Social Pools until you can manage to find an open and more natural locale or speak with someone who understands your mental state."],
            nativeDisciplines: ["animalism", "presence", "protean", "spiritus"],
        },
    Caitiff: {
        name: "Caitiff",
    ...
    banes: ["Outcast: Increasing discipline levels costs XP equal to 6x the new level. (instead of 5x)"],
        compulsions: ["Caitiffs have no compulsion"],
        nativeDisciplines: [
            "animalism",
            "auspex",
            "celerity",
    ...
    banes: [
        ...
        compulsions: ["Devil's Bargain - Take a two dice penalty to all dice pools until you fail a test and agree to Succeed at a Cost, which brings success via demonic interference but always causes another problem."],
    ...
    Ghoul: {
        ...
        compulsions: ["Servitude: Ghouls feel compelled to serve and please their vampiric master. When acting against their domitor's wishes, suffer a two-dice penalty to all rolls."],
        nativeDisciplines: [
            "animalism",
            "auspex",
            "celerity",
    ...
    Giovanni: {
        ...
        nativeDisciplines: ["dominate", "fortitude", "oblivion", "necromancy"],
    },
    Cappadocian: {
        name: "Cappadocian",
        ...
        banes: [
            ...
            "Dance with Death: Intimacy with death affects the Necromancers to such an extent that they struggle to mimic the appearance of the living more so than the other clans. To use the Blush of Life, a Cappadocian must roll a number of Rouse Checks equal to their Bane Severity instead of one. Other penalties to the Blush of Life such as from following an inhuman Road are calculated after. Even when using the Blush of life, their skin appears ashen and cold to the touch like that of a corpse, represented by the Cappadocians having the Looks Flaw (•): Ugly. A Cappadocian may also start off with or automatically develop Repulsive upon reaching Blood Potency 5, represents an even higher degree of decay and rot with some Cappadocian elders exhibiting an almost-skeletal appearance that endangers the masquerade."
        ],
        compulsions: [
            "Morbidity: The vampire must move something from life to death or vice versa, any action not taken to end or resurrect something suffers a two-dice penalty. The subject does not have to be a living thing and can instead be an object or more abstract such as ideas or conversation points. This Compulsion lasts until they manage to kill or return something to life.",
            "The Great Enigma: The Clan Cappadocian is built upon many millennia of hoarding knowledge, as commanded by Cappadocious the Wise. Most of that knowledge serves one purpose – solving the Great Enigma. A Cappadocian suffers a two-dice penalty on actions not directly spent on working towards directly researching the Great Enigma; contemplating death, dissecting dead bodies, interviewing the dead or debating on the nature of death. The compulsion ends when they have expanded or tested their knowledge be it philosophical, practical or medical."
        ],
        nativeDisciplines: ["auspex", "protean", "oblivion", "necromancy"],
    },
    Samedi: {
        name: "Samedi",
    ...
    Aquarii: {
        ...
        compulsions: ["Neptune's Call:There is a call to the sea and water."],
    ...
    Tlahuelpuchi: {
        ...
        compulsions: ["Divine Right: You suffer a 2-Die penalty to all pools not meant to elicit praise, reverence, or fear from those around you. This compulsion lasts until the end of the scene, or until someone pays you or your personal goals proper homage in a way that doesn’t conflict with your current Ambition or Desire."],
