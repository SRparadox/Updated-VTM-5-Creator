    ...
    celerity: {
        ...
        powers: [
            ...
            // Amalgam Powers
            {
                ...
                description: "Expediency, rather than creativity, is this Fiend's preference. The user halves the normal time requirements to manifest any of his metamorphosis effects. The user can voluntarily apply this upgrade to any of his metamorphosis abilities. However, if he does decide to apply the upgrade and rolls a 1 on any required Rouse Checks then the augmented ability automatically fails as the modification runs out of control. If the user is targeting himself with a metamorphosis ability and this occurs, then the power fails and they suffer a point of Aggravated Health Damage.",
                summary: "Upgrade: Halve metamorphosis casting time, but risk of failure and damage on bad Rouse Checks",
                rouseChecks: 0,
    ...
    protean: {
        ...
        powers: [
            ...
            { 
                ...
                dicePool: "Oblivion + metamorphosis", 
                level: 1, 
                discipline: "protean" 
            },
            { 
